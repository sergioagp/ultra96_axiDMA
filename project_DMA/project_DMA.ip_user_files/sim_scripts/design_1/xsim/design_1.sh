...
xvlog_opts="--relax -L axi_vip_v1_1_4 -L zynq_ultra_ps_e_vip_v1_0_4 -L smartconnect_v1_0 -L xilinx_vip"
xvhdl_opts="--relax"
...
{
  file="xsim.ini"
  lib_map_path="/home/spereira/opt/Xilinx/Vivado/2018.3/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
